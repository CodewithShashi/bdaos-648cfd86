  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pb-20 md:pb-28">
        <Container>
          {/* filter nav */}
          <div className="flex flex-wrap items-center justify-center gap-1.5 rounded-3xl sm:rounded-full border border-border bg-secondary/40 p-1.5 mx-auto w-fit max-w-full">
            {filters.map((f) => (
              <button
                key={f}
                onClick={() => setFilter(f)}
