        ...
        >
          {reviews.map((r) => (
            <motion.figure
              ...
              whileHover={{ y: -4 }}
              className="group relative flex flex-col justify-between rounded-3xl border border-border bg-secondary/40 p-7 transition hover:bg-secondary/70 hover:shadow-elevated"
            >
              <div>
